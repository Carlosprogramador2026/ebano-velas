    ...
    <div className="fixed inset-0 z-50 flex justify-end">
      ...
      >
          ...
          <nav className="mt-8 space-y-3">
            {links.map((link, idx) => (
              <button
                ...
                className="w-full min-h-[48px] text-left py-2.5 px-3 rounded-xl hover:bg-white/5 flex items-center justify-between group transition-colors cursor-pointer"
              >
                <div className="flex items-center gap-3">
                  <span className="text-xs font-mono text-[#c6a779]/60 group-hover:text-[#d4af37]">
                    0{idx + 1}
                  </span>
        ...
        <div className="pt-6 border-t border-white/10 space-y-3">
          {/* Language Switch */}
          <div className="flex items-center justify-between p-2 sm:p-3 rounded-xl bg-[#14120f] border border-white/5">
            ...
            <div className="flex gap-1.5">
              <button
                ...
                className={`min-w-[44px] min-h-[44px] flex items-center justify-center rounded-lg text-xs font-cinzel font-bold cursor-pointer ${
          ...
          <button
            ...
            className="w-full min-h-[48px] flex items-center justify-between p-3 rounded-xl bg-[#14120f] border border-white/5 text-xs text-[#a89d8d] hover:text-white cursor-pointer"
          >
            <div className="flex items-center gap-2">
              {isPlayingSound ? (
