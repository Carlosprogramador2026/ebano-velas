                ...
                <div className="flex-1 min-w-0 flex flex-col justify-between">
                  <div className="flex items-start justify-between">
                    ...
                    <button
                      ...
                      className="text-[#a89d8d] hover:text-red-400 p-1"
                  ...
                  <div className="flex items-center justify-between mt-2">
                    ...
                    <div className="flex items-center border border-[#c6a779]/30 rounded-full bg-[#0d0c0a]">
                      <button
                        onClick={() => onUpdateQuantity(item.vessel.id, -1)}
                        className="w-7 h-7 flex items-center justify-center text-[#ede4d8] hover:text-[#d4af37]"
                        aria-label="Decrease quantity"
                      >
                        <Minus className="w-3 h-3" />
                      </button>
                      <span className="w-6 text-center text-xs font-mono font-bold text-[#f2ebe1]">
                        {item.quantity}
                      </span>
                      <button
                        onClick={() => onUpdateQuantity(item.vessel.id, 1)}
